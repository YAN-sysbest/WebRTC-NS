...
typedef struct NoiseSuppressionC_ {
    ...
    float density[SIMULT * HALF_ANAL_BLOCKL];//概率密度
    float lquantile[SIMULT * HALF_ANAL_BLOCKL];//对数分位数
    ...
    float featureData[7];//0为频谱平坦度 ，3为logLRT均值特征，data4为频谱模板差异特征，data6为平均幅度谱
